...
let cliente1 = new cliente.Cliente("Portugal",1564446,"Baltazar",46654,5);
let cliente2 = new cliente.Cliente("Colombia",97809707,"Enzo",46654,5);
let cliente3 = new cliente.Cliente("Colombia",97809707,"Enzo2",46654,5);
let cliente4 = new cliente.Cliente("Colombia",97809707,"Enzo3",46654,5);
let cliente5 = new cliente.Cliente("Colombia",97809707,"Enzo4",46654,5);
